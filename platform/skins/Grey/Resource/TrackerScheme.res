...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"56 56 56 255"	// used in text windows, lists
		"BrightBaseText"		"56 56 56 255"	// brightest text
		"SelectedText"		"64 64 64 255"	// selected text
		"DimBaseText"		"80 80 80 255"	// dim base text
		"LabelDimText"		"112 112 112 255"	// used for info text
		"ControlText"		"64 64 64 255"	// used in all text controls
		"BrightControlText"	"64 64 64 255"	// use for selected controls
		"DisabledText1"		"236 236 236 255"	// disabled text
		"DisabledText2"		"148 148 148 255"	// overlay color for disabled text (to give that inset look)
		"DimListText"		"112 112 112 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"206 206 206 255"		// background color of controls
		"ControlDarkBG"		"164 164 164 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"194 194 194 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"224 156 48 255"	// background color of any selected text or menu item
		"SelectionBG2"		"164 164 164 255"		// selection background in window w/o focus
		"ListBG"			"194 194 194 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"56 56 56 255"
